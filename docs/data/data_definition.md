...
Teniendo en cuenta que se esta implementando un modelo de Fine Tunnig, para la extracción de características del conjunto de imágenes de entrenamiento, se utiliza la red convolucional preeentrenada ResNet50V2, sin las capas densas del final.
