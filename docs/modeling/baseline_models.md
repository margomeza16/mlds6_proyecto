...
A continuación se muestra la comparación de las curvas de pérdida (imágen de la izquierda) y accuracy (imágen de la derecha) de los modelos de transfer learning y fine tuning:
